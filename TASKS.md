...
| B1 cross-major guard | [35284975413](https://github.com/senhakan/pgdumpplus/actions/runs/35284975413) | Commit 3ab641f: patched clients reject a connected server with a newer PostgreSQL major before export; PG13.23/17.11/18.6 builds, matching-major verification and package smoke tests passed | A dedicated negative cross-major integration environment is still useful before B1 is closed |
