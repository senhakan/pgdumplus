...
| B1 DEB upgrade ordering | [35282363764](https://github.com/senhakan/pgdumpplus/actions/runs/35282363764) | Commit 074debd: disposable lower-project-version DEB fixture upgraded to the current package in runtime-only containers across Ubuntu 22.04/24.04 and Debian 12; install, version change, binary checks and removal passed | RPM project-version-only upgrade fixture remains to be added |
